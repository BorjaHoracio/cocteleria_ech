...
class CustomImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String notFountImage = 'https://firebasestorage.googleapis.com/v0/b/echcocteleria.appspot.com/o/Files%2Fnot%20found.png?alt=media&token=2622403a-7b94-4779-baf3-4102782f85c1';
    return 
      Container(width: width, height: height,
        ...
        child: isNetwork ?
          CachedNetworkImage(
            imageUrl: image == '' ? notFountImage : image,
